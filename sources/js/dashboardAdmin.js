...
const estadoDetalleUsuarioAdmin = document.querySelector('.estado-detalles-usuario-admin');
const aprobacionDetalleUsuarioAdmin = document.querySelector('.aprobacion-detalles-usuario-admin');
...
if(estadoDetalleUsuarioAdmin){
    if(estadoDetalleUsuarioAdmin.textContent.trim() == 'Activa'){
        estadoDetalleUsuarioAdmin.style.color = 'green';
    }else{
        estadoDetalleUsuarioAdmin.style.color = 'red';
    }
}else{
    console.log('Elemento no encontrado en el DOM');
};

if(aprobacionDetalleUsuarioAdmin){
    if(aprobacionDetalleUsuarioAdmin.textContent.trim() == 'Aprobada'){
        aprobacionDetalleUsuarioAdmin.style.color = 'green';
    }else{
        aprobacionDetalleUsuarioAdmin.style.color = 'red';
    }
}else{
    console.log('Elemento no encontrado en el DOM');
};
...
if(cerrarDetallesUsuarioAdmin){
    cerrarDetallesUsuarioAdmin.addEventListener('click', cerrarModal);
}else{
    console.log('Elemento no encontrado en el DOM');
};
